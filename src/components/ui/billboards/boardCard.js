import { Badge, Box, HStack, Icon, IconButton, Modal, ModalBody, ModalCloseButton, ModalContent, ModalHeader, ModalOverlay, Stack, Text, VStack, useDisclosure, useToast } from '@chakra-ui/react'
...
export const BoardCard=({board})=>{
    ...
    const {
        ...
        location, 
        bob_rating, 
        img_placeholder = "https://firebasestorage.googleapis.com/v0/b/billonoard.appspot.com/o/profile_photo%2Fandroid-chrome-192x192.pngf512460f-12f4-4579-970a-8afb032bb687?alt=media&token=dcc45251-1db7-4a53-b0e3-feb5b43c30c5",
        advertisement_data 
    } = {...board};
  ...
  return (
    <Box w='100%' h='250px' borderRadius={'md'} boxShadow={'md'} position={'relative'}>
        <Modal isOpen={view_image_modal?.isOpen} onClose={view_image_modal?.onClose} isCentered>
            <ModalOverlay />
            <ModalContent>
                <ModalHeader>{name_of_billboard}</ModalHeader>
                <ModalCloseButton />
                <ModalBody>
                    <Box position="relative" w={400} h={400}>
                        <Image 
                            src={advertisement_data?.length > 0 && advertisement_data[advertisement_data.length - 1]?.image_url !== ''? advertisement_data[advertisement_data.length - 1]?.image_url: img_placeholder} 
                            fill
                            alt='board'
                            style={{ objectFit: "cover", borderRadius: "8px" }}
                            // overrideSrc='https://firebasestorage.googleapis.com/v0/b/billonoard.appspot.com/o/profile_photo%2Fandroid-chrome-192x192.pngf512460f-12f4-4579-970a-8afb032bb687?alt=media&token=dcc45251-1db7-4a53-b0e3-feb5b43c30c5'
                        />
                    </Box>
                </ModalBody>
            </ModalContent>
        ...
        <Box position="relative" w="full" h="full">
            <Image 
                ...
                style={{ objectFit: "cover", borderRadius: "8px" }}
                // overrideSrc='https://firebasestorage.googleapis.com/v0/b/billonoard.appspot.com/o/profile_photo%2Fandroid-chrome-192x192.pngf512460f-12f4-4579-970a-8afb032bb687?alt=media&token=dcc45251-1db7-4a53-b0e3-feb5b43c30c5' 
                onClick={(()=>{view_image_modal?.onToggle()})}
            />
        </Box>
