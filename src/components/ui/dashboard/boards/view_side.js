...
import DeleteSideBoardUi from './delete_sideboard.ui';

export const View_side_Board=({data,view_side_disclosure})=>{
    const {set_page,set_side_board_data} = useContext(dashboardContext);
    const delete_sideboard_disclosure = useDisclosure();
    const HandleEditSideBoard = ()=>{
        set_page('Edit_Side');
    ...
    return(
        ...
        >
            ...
            <DrawerFooter>
                <DeleteSideBoardUi delete_sideboard_disclosure={delete_sideboard_disclosure}/>
                <Button variant='outline' mr={3} onClick={HandleDeleteSideBoard} _hover={{bgColor:'red'}}>
                    Delete
                </Button>
                <Button variant='outline' mr={3} onClick={HandleEditSideBoard}>
                    Edit
                </Button>
